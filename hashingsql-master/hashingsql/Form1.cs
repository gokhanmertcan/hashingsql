...
namespace hashingsql
{
    ...
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=GOKHAN-PC;Initial Catalog=user;Integrated Security=True");
        ...
        {
            con = new SqlConnection("Data Source=GOKHAN-PC;Initial Catalog=user;Integrated Security=True");
        ...
        public void sccHesapla() //sccleri hesaplamak için veritabanına attığımız cc1,cc2 ve cc3 bilgilerini toplamamız gerek
        {
            ...
            SqlCommand cmd;
            cmd = new SqlCommand();
            SqlConnection con1 = new SqlConnection("Data Source=GOKHAN-PC;Initial Catalog=user;Integrated Security=True");
            con1.Open();
            cmd.Connection = con1;
